...
<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
    ...
    <div id="header" class="header navbar-default">
        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand"><span class="navbar-logo"></span> <b>Dashboard</b></a>
        ...
        <!-- end navbar-header -->
        <?php
            if(isset($this->session->userdata['uid']) && !empty($this->session->userdata['uid'])){
        ...
        <ul class="navbar-nav navbar-right">
            <?php if(!empty($this->session->userdata['role']) && $this->session->userdata['role'] == 0){ ?>
                <li class="dropdown">
