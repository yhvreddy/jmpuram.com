    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-header">
            <div class="brand">
                ...
                <small>User Forget Password..!</small>
            </div>
            <div class="icon">
        ...
        <div class="login-content">
            <form action="<?= base_url('user/saveforgetpassword') ?>" method="POST" class="margin-bottom-0">
                <div class="form-group m-b-20">
                    <input type="email" class="form-control form-control-lg" placeholder="Enter Register eMail" required  id="reg_email" name="email_id" autofocus="autofocus" value="">
                </div>
                ...
                <div class="m-t-20">
                    <a href="<?=base_url('user/registeraccount')?>"> Register New Account </a>
                    <a href="<?=base_url()?>" class="pull-right">Login Account..!</a>
                </div>
            </form>
        </div>
        <!-- end login-content -->
