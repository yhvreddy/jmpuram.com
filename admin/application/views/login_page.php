    ...
    <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-header">
            <div class="brand">
                ...
                <small>User Login Account..!</small>
            </div>
            <div class="icon">
        ...
        <div class="login-content">
            <form action="<?= base_url('user/loginAccess') ?>" method="POST" class="margin-bottom-0">
                <div class="form-group m-b-20">
                    <input type="text" class="form-control form-control-lg" placeholder="Enter Username" required  id="userName" name="userName" autofocus="autofocus" value="">
                </div>
                <div class="form-group m-b-20">
                ...
                <div class="login-buttons">
                    <button type="submit" class="btn btn-success btn-block btn-lg">Login Account</button>
                </div>
                <div class="m-t-20">
                    <a href="<?=base_url('user/registeraccount')?>" style="display: none"> Register New Account </a>
                    <a href="<?=base_url('user/forgetpassword')?>" class="pull-right">Forget Password..!</a>
                </div>
            </form>
        </div>
        <!-- end login-content -->
